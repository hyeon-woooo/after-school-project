...
sentence8 = "C:\Users\ahora\Desktop\2022.7._python_basic\02_문자열.py" # 오류 / 문장 내 \를 표기하기 위해서는 \\ 사용 36번이 그 예시
print(sentence8) 
...
print("Redd\bApple") # RedApple / \b 앞글자를 지우고 뒤 문자를 이어서 작성함 \b=backspace

print("Red\tApple") # Red     Apple / \t는 Tab 기능 탭 = 스페이스 4번 (4타) 


# ==== 슬라이싱 ==== 대괄호에 숫자 넣기
jumin = "050302-3456789"
print("성별 : " + jumin[7]) # 3
print("연 : " + jumin[0:2]) # 0~2 직전까지 -> # 05 / 가져올 자리 1보다 하나 더 큰수 적어야 함
print("월 : " + jumin[2:4])
print("일 : " + jumin[4:6])
print("생년월일 : " + jumin[0:6]) # jumin[:6] 과 동일 (0 생략 가능)
print("뒤 7자리 : " + jumin[7:]) # 7부터 끝까지 = [7:0]
...
print(text[0].isupper()) # text[0]=P 가 대문자인지 확인 true or false / True / True는 1이고 False는 0이다.
...
age = 18
color = "빨강"
print(f"나는 {age}살이며, {color}색을 좋아해요.") # 나는 18살이며, 빨강색을 좋아해요. format을 쓰지 않을때는 문자 앞에 f를 넣는다